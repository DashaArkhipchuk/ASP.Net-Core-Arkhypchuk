...
namespace WebAppDemoApi.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public WeatherForecastController(ILogger<WeatherForecastController> logger, FileStoreService fileStoreService) //параметри підставляє сам ASP.NET через Dependency injection (сервіси- словники, де значення- logger)
        {
            _logger = logger;
            _fileStoreService = fileStoreService;
        }
        // /weatherforecast ( routing )
